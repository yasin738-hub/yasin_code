...
<?php echo'<div class="shadow-lg p-3 mt-5 mb-1 bg-white rounded"> hello '.$_SESSION['user']->NAME.'</div>'; ?>
<a class="btn btn-light p-2 mb-1 shadow w-100" href="profile.php">تعدل الملف الشخصي</a>
<a class="btn btn-light p-2 mb-1 shadow w-100" href="search.php">ادارة المستخدمين</a>
<form method='POST'><button class='btn btn-outline-danger w-100' type='submit' name='logout'>تسجل خروج</button></form>
